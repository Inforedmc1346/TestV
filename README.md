...
Ping.Parent.Text = ("Ping: " ..game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString(math.round(2/ping)))
	...
	function uitab:AddTab(text,icon)
...
local NguyenTien = AppleUi:AddTab("ℹ️Information","")
local Main = AppleUi:AddTab("🏠Main","")
local M = AppleUi:AddTab("🗡️Item","")
local Ss = AppleUi:AddTab("📊Stats","")
local RaceV4 = AppleUi:AddTab("🥋Race V4","")
local P = AppleUi:AddTab("⚔️PVP","")
local R = AppleUi:AddTab("🥷🏿Dungeon","")
local T = AppleUi:AddTab("✈️Teleport","")
local S = AppleUi:AddTab("🛍️Shop","")
local D = AppleUi:AddTab("🍎Devil Fruit","")
local Misc = AppleUi:AddTab("🎋Misc","")
--- Thông Tin
