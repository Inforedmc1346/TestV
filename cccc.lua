getgenv().Config = {
    ...
    ["Misc"] = {
        ["Fps Boost"] = false, --// Reduce Lag
        ["White Screen"] = false, --// Enable White Screen
        ["Random Suprise"] = true, --// Random Bone
        ["Random Fruit & Store"] = true, --// Random Fruit
...
function Notify(content)
    ...
    OrionLib:MakeNotification({
        Name = "Hirimi Hub Auto Bounty V2",
        Content = content,
...
LogoHub.Image = "rbxassetid://15660291299"
...
function wEarn(targ, earn,total) 
    if getgenv().Config.WebHook.Enable and targ ~= nil then
        local data = {
            ...
            ["embeds"] = {
                {
                    ["title"] = "**MTriet Hub Auto Bounty V2**",
                    ["color"] = 0xeb4034,
                    ["fields"] = {
                        {
                            ["name"] = "Account: ",
                    ...
                    ["footer"] = {
                        ["text"] = "MTriet Hub - discord.gg/mtriethub",
                    },
